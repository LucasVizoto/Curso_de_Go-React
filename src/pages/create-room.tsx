        ...
        <main className='h-screen flex items-center justify-center px-4'>
            <div className='max-w[450px] flex flex-col gap-6'>
                ...
                <form 
                    ...
                    className='flex iten-center gap-2 bg-zinc-980 p-2 rounded-xl border border-zinc-800 ring-orange-400 ring-offset-2 ring-offset-zinc-950 focus-within:ring-2'
                >
                    <input type="text" 
                    name='theme'
                    ...
                    required //faz com que o input seja obrigatório
                    />
